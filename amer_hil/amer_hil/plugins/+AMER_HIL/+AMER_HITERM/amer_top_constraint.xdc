...
#Sigma-delta channels
#IO_L15P_T2_DQS_34 jb_p[0] JB1
set_property PACKAGE_PIN T20 [get_ports {sd[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sd[0]}]
set_property DRIVE 4 [get_ports {sd[0]}]
set_property SLEW SLOW [get_ports {sd[0]}]

#IO_L16P_T2_34 jb_p[1] JB3
set_property PACKAGE_PIN V20 [get_ports {sd[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sd[1]}]
set_property DRIVE 4 [get_ports {sd[1]}]
set_property SLEW SLOW [get_ports {sd[1]}]

#IO_L17P_T2_34 jb_p[2] JB7
set_property PACKAGE_PIN Y18 [get_ports {sd[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sd[2]}]
set_property DRIVE 4 [get_ports {sd[2]}]
set_property SLEW SLOW [get_ports {sd[2]}]

#IO_L22P_T3_34 jb_p[3] JB9
set_property PACKAGE_PIN W18 [get_ports {sd[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sd[3]}]
set_property DRIVE 4 [get_ports {sd[3]}]
set_property SLEW SLOW [get_ports {sd[3]}]

#IO_L10P_T1_34 jc_p[0] JC1
set_property PACKAGE_PIN V15 [get_ports {sd_clk_0}]
set_property IOSTANDARD LVCMOS33 [get_ports {sd_clk_0}]
set_property DRIVE 4 [get_ports {sd_clk_0}]
set_property SLEW SLOW [get_ports {sd_clk_0}]

#IO_L8P_T1_34 jc_p[2] JC7
set_property PACKAGE_PIN W14 [get_ports {sd_clk_90}]
set_property IOSTANDARD LVCMOS33 [get_ports {sd_clk_90}]
set_property DRIVE 4 [get_ports {sd_clk_90}]
set_property SLEW SLOW [get_ports {sd_clk_90}]

#Slow IO extension pins
#IO_L5P_T0_34 jd_p[0] JD1
set_property PACKAGE_PIN T14 [get_ports {ioext_spi_clk}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioext_spi_clk}]

#IO_L6P_T0_34 jd_p[1] JD3
set_property PACKAGE_PIN P14 [get_ports {ioext_spi_cs}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioext_spi_cs}]

#IO_L11P_T1_SRCC_34 jd_p[2] JD7
set_property PACKAGE_PIN U14 [get_ports {ioext_spi_miso}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioext_spi_miso}]

#IO_L21P_T3_DQS_34 jd_p[3] JD9
set_property PACKAGE_PIN V17 [get_ports {ioext_spi_mosi}]
set_property IOSTANDARD LVCMOS33 [get_ports {ioext_spi_mosi}]
